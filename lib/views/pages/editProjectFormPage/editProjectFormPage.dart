...
class EditProjectFormPage extends StatelessWidget {
  String projectName = "";
  String projectDetails = "";

  final savedProjectName;
  final savedProjectDetails;
  final savedContributors;
  ...
  void onSubmit(BuildContext context, String) {
    // SUBMIT CONTROLLER FUNCTION CALL TO SAVE IN FIREBASE
    formSaveController
        .editProject(projectName, projectDetails, savedContributors)
        .catchError(
      (error) {
        showDialog(
          context: context,
              ...
              return IconButton(
                onPressed: () {
                  ...
                  for (int i = 0; i < selectedContributorsIndex.length; i++) {
                    EditProjectFormPage.selectedContributorsName
